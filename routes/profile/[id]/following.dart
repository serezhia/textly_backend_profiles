...
FutureOr<Response> _get(RequestContext context, String id) async {
  ...
  try {
    logger.d(
      '$uuid: Searching following, userId: $userId, reqUserId: $reqUserId',
    );
    final profiles = await profileRepository.readFollowing(
      userId: userId,
      reqUserId: reqUserId,
      offset: offset,
      limit: limit,
    ...
    logger.d('$uuid: Successfully founded following, userId: $userId');
    return TextlyResponse.success(
      uuid: uuid,
      message:
          '''Following has been founded successfully, userId: $userId, reqUserId: $reqUserId''',
      data: {
    ...
    logger.e(
      '''$uuid: Error founding following, userId: $userId, reqUserId: $reqUserId , error: $e''',
    );
